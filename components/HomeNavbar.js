...
import children from '../Netflix-images/children.jpg';
  ...
  return (
    <div className={isscrolled == true ? styles.outer1 : styles.outer}>
      ...
      <div className={styles.right}>
        <div
          className={
            searchbarshow == true ? styles.searchbar : styles.searchbar1
          }
        >
          <svg
          ...
          {searchbarshow == true ? (
            <div
              className={styles.searchbar_emptydiv}
        ...
        <div className={styles.data_type}>
          <Image src={children} className={styles.children} />
        </div>
        <button onClick={handleexit} className={styles.exit}>Exit Children</button>
